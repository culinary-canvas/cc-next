...
import { transformToDb } from '../../services/db/decorators/transformToDb.decorator'
import { transformToApp } from '../../services/db/decorators/transformToApp.decorator'
...
class Time implements DateTimeInterface {
  ...
  toApp(obj: firebase.firestore.Timestamp) {
    if (obj) {
      return Time.createFromFirestoreTimestamp(obj)
    }
  }
