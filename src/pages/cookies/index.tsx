  ...
  return (
    <article className="container page">
      ...
      <p>
        ...
        how and they&#039;re being used by the culinary-canvas.com website
        (&quot;Website&quot; or &quot;Service&quot;) and any of its related
        products and services (collectively, &quot;Services&quot;). This Policy
        is a legally binding agreement between you (&quot;User&quot;,
        &quot;you&quot; or &quot;your&quot;) and Culinary Canvas (&quot;Culinary
        Canvas&quot;, &quot;we&quot;, &quot;us&quot; or &quot;our&quot;). You
        ...
        <a title="Culinary Canvas privacy policy" rel="nofollow" href="https://culinary-canvas.com/privacy">
          Privacy Policy
        </a>
        .
      </p>
      ...
      <p>
        ...
        etc) let us track social network users when they visit or use the
        Website and Services, or share content, by using a tagging mechanism
        provided by those social networks.
      </p>
      <p>
      ...
      <p>
        ...
        you might not be able to use all of the features the Website and
        Services offer.
      </p>
